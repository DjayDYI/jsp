	...
	<BODY>
		<CENTER>
			...
			<FORM ACTION="Login" METHOD="POST">
		   		<BR>
		   		<BR>
		   		User Id : <INPUT TYPE="TEXT" NAME="userIdBD" VALUE="ift287_14">
		   		<BR>
		   		<BR>
		   		Mot de passe : <INPUT TYPE="PASSWORD" NAME="motDePasseBD" VALUE="mohngo">
		   		<BR>
		   		<BR>
		   		Serveur : <SELECT NAME="serveur">
		           		    <OPTION VALUE="local">local
		               		<OPTION VALUE="dinf" selected>dinf
		             		</SELECT>
		   		<BR>
		   		<BR>
		   		<BR>
		   		BD : <INPUT TYPE="TEXT" NAME="bd"  VALUE="ift287_14db">
				<BR>
				<BR>
